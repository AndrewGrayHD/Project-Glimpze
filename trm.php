                   ...
                   <div class="row">
                       <div class="col-sm-12">
                           <div class="main-sparkline12-hd">
                             <h4 id="NotifTitle">Termination</h4>
                            </div>
                       </div>  
                   </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="form-group">
                                         <div class="row">
                                        <div class="col-sm-4">
                                        <label id="resonTxt" class="login2 pull-right pull-right-pro">Reason of termination</label>
                                        </div>
                                         <div class="col-sm-5">
    ...
    <script src="js/main.js"></script>
     ...
     <script type="text/javascript">
            ...
            $("#SubmitTerm").click(function(){
                ...
                var dataVal=[EmpIDVal,EmpName,ProcessVal,SupervisorVal,LWDVal,EffectivedVal,"Terminated",ReasonTermVal];
