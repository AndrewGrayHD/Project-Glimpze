                   ...
                   <div class="row">
                       <div class="col-sm-12">
                           <div class="main-sparkline12-hd">
                             <h4 id="NotifTitle">Suspension</h4>
                            </div>
                       </div>  
                   </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="form-group">
                                         <div class="row">
                                        <div class="col-sm-4">
                                        <label id="resonTxt" class="login2 pull-right pull-right-pro">Reason of suspension</label>
                                        </div>
                                         <div class="col-sm-5">
    ...
    <script src="js/main.js"></script>
     ...
     <script type="text/javascript">
             ...
             $(document).ready(function () {
                ...
                if(event.keyCode==13){
                 ...
                 function validateExistedandAutofill(){
                                ...
                                data:{functionNumber:3,AutoEmpID:EmpdID,categoryCode:4},
                                type: 'post',
                                success: function(data){
            ...
            $("#SubmitTerm").click(function(){
                ...
                var dataVal=[EmpIDVal,EmpName,ProcessVal,SupervisorVal,LWDVal,EffectivedVal,"4",ReasonTermVal];
