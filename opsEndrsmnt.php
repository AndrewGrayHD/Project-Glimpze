      ...
      <div class="advanced-form-area mg-tb-15">
        <div class="container-fluid">
          <div class="row">   
                          ...
                          <div class="all-form-element-inner">
                             ...
                             <div class="row">
                                <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                      <label class="login2  pull-right-pro"><u>For Operation List</u></label>
                                </div>
                            </div>
                            <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <button  name="OperationEndorsementArrowRight" type="button" class="btn btn-custon-three btn-default btn-sm pull-right col-sm-5"><i class="fa big-icon fa-chevron-right icon-wrap"></i><i class="fa big-icon fa-chevron-right icon-wrap"></i></button>
                                               
                                                   
                                            
                                  
                                             <label class="login2  pull-right-pro">Select All</label>
                                            <input  type="checkbox" name="OperationselectAllagent">
                                  
                                           <select class="form-control"   name="OperationEndorsementAgentList" multiple="" size="18">
                                                       
                                          </select>
                                        </div>

                                        <div class="form-group">
                                            <button  name="OperationEndorsementFilterButton" type="button" class="btn btn-custon-three btn-default btn-sm" data-toggle="modal" data-target="#OperationEndorsementModal">Filter</button>  
                                        </div>
                                    </div>

                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <button  name="OperationEndorsementLeftArrow" type="button" class="btn btn-custon-three btn-default btn-sm pull-right col-sm-5"><i class="fa big-icon fa-chevron-left icon-wrap"></i><i class="fa big-icon fa-chevron-left icon-wrap"></i></button>
                                               
                                              <label class="login2  pull-right-pro">Select All</label>
                                            <input  type="checkbox"  name="OperationselectAllTrainning">       
                                        
                                            <select class="form-control"  name="OperationEndorsementforTrainingList" multiple="" size="18">
                                ...
                                <div class="col-sm-4">
                                         ...
                                         <div class="form-group">
                                        <label class="login2  pull-right-pro">Live Start Date</label>
                                        <div class="form-group data-custon-pick" id="data_1">
                                        <div class="input-group date">
                                           
                                            <input type="text"  class="form-control" name="OperationEndorsementLiveStartDate" />
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="touchspin-inner">
                                            ...
                                            <input class="touchspin1" type="text"  name="OperationEndorsementNumBillable">
                                        </div>
                                        </div>
                                         <div class="form-group">
                                         <button class="btn btn-lg btn-primary login-submit-cs pull-right" type="submit" id="OperationsaveEndorsementTraining"><i class="fa big-icon fa-save icon-wrap"></i></button>
                                        </div>
                                </div>
                            </div>  
                              ...
                              <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <select name="OperationEndorsementProcessModal" class="form-control">
                             ...
                             <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <select name="OperationEndorsementTrainer" class="form-control">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <select name="OperationEndorsementBatch" class="form-control">
           ...
           <button name="OperationEndorsementProceedButton" type="button" class="btn btn-default"  data-dismiss="modal">Proceed Filter</button>
    ...
    <script src="js/main.js"></script>
     ...
     <script type="text/javascript">
             ...
             $(document).ready(function () {
                ...
                $("[name=OperationEndorsementFilterButton]").click(function(){

                       
                        
                         $.ajax({
                                url: 'php/endorsementFunction.php',
                                data:{functionNumber:7,STRCode1:2},
                                type: 'post',
                                ...
                                $("[name=OperationEndorsementProcessModal]").empty();
                                $("[name=OperationEndorsementProcessModal]").append(appendstring);
                ...
                $("[name=OperationEndorsementProcessModal]").change(function(){

                     supervisorCategory();
                });

                  $("[name=OperationEndorsementTrainer]").change(function(){
                     BatchCategory();
                });
                ...
                function supervisorCategory(){
                    ...
                    var IfProcessDataVal=$("[name=OperationEndorsementProcessModal]").val();
                         

                         $.ajax({
                                url: 'php/endorsementFunction.php',
                                data:{functionNumber:8,IfProcessHaveData2:IfProcessDataVal,STRCode2:2},
                                type: 'post',
                                success: function(data){
                                ...
                                $("[name=OperationEndorsementTrainer]").empty();
                                $("[name=OperationEndorsementTrainer]").append(appendstring);
                ...
                function BatchCategory(){
                        ...
                        var IfProcessDataVal=$("[name=OperationEndorsementProcessModal]").val();
                        var IFTrainerDataVal=$("[name=OperationEndorsementTrainer]").val();

                         $.ajax({
                                url: 'php/endorsementFunction.php',
                                data:{functionNumber:8,IfProcessHaveData3:IfProcessDataVal,IfTrainerHaveDataVal:IFTrainerDataVal,STRCode3:2},
                                type: 'post',
                                success: function(data){
                                ...
                                $("[name=OperationEndorsementBatch]").empty();
                                $("[name=OperationEndorsementBatch]").append(appendstring);
                ...
                $("[name=OperationEndorsementProceedButton]").click(function(){

                    var EndorsementProcessModal=$("[name=OperationEndorsementProcessModal]").val();
                    var EndorsementCategoryModal=$("[name=OperationEndorsementTrainer]").val();
                    var EndorsementBatchModal=$("[name=OperationEndorsementBatch]").val();
                    ...
                    if(EndorsementProcessModal !="" && EndorsementCategoryModal !="" && EndorsementBatchModal!=""){
                       ...
                       $.ajax({
                                url: 'php/endorsementFunction.php',
                                data:{functionNumber:10,EndorsementProcessModalC2:EndorsementProcessModal,EndorsementCategoryModalC2:EndorsementCategoryModal,EndorsementBatchModalC2:EndorsementBatchModal,STRCode4:2},
                                type: 'post',
                                success: function(data){
                                ...
                                $("[name=OperationEndorsementAgentList]").empty();
                                $("[name=OperationEndorsementAgentList]").append(appendstring);
                ...
                $("[name=OperationselectAllagent]").click(function(){

                        $("[name=OperationEndorsementAgentList]").focus();
                        if($(this).prop("checked")==true){
                            $("[name=OperationEndorsementAgentList] option").prop("selected",true);
                        }else if($(this).prop("checked")==false){

                             $("[name=OperationEndorsementAgentList] option").prop("selected",false);
                        }
                 ...
                 $("[name=OperationselectAllTrainning]").click(function(){

                        $("[name=OperationEndorsementforTrainingList]").focus();
                        if($(this).prop("checked")==true){
                            $("[name=OperationEndorsementforTrainingList] option").prop("selected",true);
                        }else if($(this).prop("checked")==false){

                             $("[name=OperationEndorsementforTrainingList] option").prop("selected",false);
                        }
                 ...
                 $("[name=OperationEndorsementArrowRight]").click(function(){

                        listpassData("OperationEndorsementAgentList","OperationEndorsementforTrainingList");


                 });

                $("[name=OperationEndorsementLeftArrow]").click(function(){

                        listpassData("OperationEndorsementforTrainingList","OperationEndorsementAgentList");
                ...
                function listpassData(List1Name,List2Name){
                  ...
                  $("#OperationsaveEndorsementTraining").click(function(){

                    if( $("[name=OperationEndorsementforTrainingList] option").size() > 0  && $("[name=OperationEndorsementLiveStartDate]").val() != "" && $("[name=OperationEndorsementNumBillable]").val() != ""){

                    var validDateFormat=/^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|[12][0-9]|3[01])[\/\-]\d{4}$/;
                     var validDateFormat2=/^\d{4}[\/\-](0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|[12][0-9]|3[01])$/;
                       
                    var dateVal=$("[name=OperationEndorsementLiveStartDate]").val();
                     if(dateVal.match(validDateFormat) || dateVal.match(validDateFormat2)){

                    if($.isNumeric($("[name=OperationEndorsementNumBillable]").val())){
                          ...
                          $.each($("[name=OperationEndorsementforTrainingList] option"), function(){ 
                        ...
                        for(var a=0; a < empID.length;a++){
                         ...
                         DataValue[3]=$("[name=OperationEndorsementLiveStartDate]").val();
                         DataValue[4]=$("[name=OperationEndorsementNumBillable]").val();
                        ...
                        alert("Error - Live Start Date field was not on required format(m/d/yyyy,d/m/yyyy,yyyy-m-d)");
                     }
